...
WebSyncProto.prototype = {
    ...
    // Function: void insertAtCursor(jQuery node);
    // Inserts a DOM element at selection cursor.
    ...
    // Function: void applyCssToSelection(hash css);
	// Applies css to the selection. Warning: This is rather slow and shouldn't be overly used.
	applyCssToSelection: function(css){
		WebSync.applier.toggleSelection();
		$(".tmp").css(css).removeClass("tmp");
	},
    // Function: void register(string PluginName, function Plugin);
	// Registers a plugin.
    ...
    // Variable: hash plugins;
    // List of all the plugins loaded.
	plugins: {},
    // Function: void alert(string Message);
    ...
    // Function: void success(string Message);
    ...
    // Function: void alert_msg(string Message, string Classes);
